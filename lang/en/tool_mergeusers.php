...
$string['frommedetail'] = 'From this account into {$a->profilelink} on {$a->time} - {$a->loglink}';
$string['tomedetail'] = 'From {$a->profilelink} into this account on {$a->time} - {$a->loglink}';
