...
$string['enableadhocmerge_desc'] = 'If enabled, allows users to merge accounts using adhoc task.';
...
$string['snapshot_anonymized_header'] = 'User Data Anonymized';
$string['snapshot_anonymized_notice'] = 'Personal data from user snapshots has been removed for privacy compliance. User IDs and merge actions are preserved for audit purposes.';
$string['snapshot_created'] = 'Created at:';
$string['snapshot_deleted'] = 'Deleted:';
$string['snapshot_email'] = 'Email:';
$string['snapshot_executed'] = 'Executed at:';
$string['snapshot_header'] = 'User information at queue time (static snapshot):';
$string['snapshot_id'] = 'ID:';
$string['snapshot_idnumber'] = 'ID Number:';
$string['snapshot_name'] = 'Name:';
$string['snapshot_queued'] = 'Queued at:';
$string['snapshot_suspended'] = 'Suspended:';
$string['snapshot_user_anonymized'] = 'User data anonymized (User ID: {$a->userid})';
