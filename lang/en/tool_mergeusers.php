...
$string['searchbyprofilefields_desc'] = 'Custom user profile fields allowed for searching users to merge, in addition to the built-in fields (username, name, email...). Leave empty to disable searching by profile field.';
