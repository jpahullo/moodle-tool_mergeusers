...
final class generic_table_merger_test extends advanced_testcase {
    /** @var int User ID to keep in tests. */
    public const USER_TO_KEEP = 1;
    /** @var int User ID to remove in tests. */
    ...
    /** @var generic_table_merger The merger instance. */
     ...
     *
     * @param object|null $record Test record
     * @param bool $withlog Whether to include logs
     ...
     *
     * @param bool $informedindex Whether informed index is used
     * @group tool_mergeusers
     * @group tool_mergeusers_generic_tablemerger
