 ...
 * @covers    \tool_mergeusers\hook\after_merged_all_tables
 */
final class after_merged_all_tables_test extends advanced_testcase {
    /**
     * Test that custom callback for after merged all tables hook is invoked.
     *
    ...
    /**
     * Test that custom callback for after merged all tables hook records an error message.
     *
     * @group tool_mergeusers
     * @group tool_mergeusers_after_merge_hook
     * @throws dml_exception
     ...
     *
     * @param string $hooksfilename The filename of the hooks file
     * @return void
     * @throws coding_exception
     */
