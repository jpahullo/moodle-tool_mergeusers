...
final class jsonizer_test extends basic_testcase {
     ...
     * @param string $expectedresult The expected JSON result
     ...
     *
     * @param string $valuetotest The JSON string to parse
     * @param mixed $expectedresult The expected parsed result
     * @group tool_mergeusers
     * @group tool_mergeusers_jsonizer
