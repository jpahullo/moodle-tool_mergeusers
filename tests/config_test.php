...
final class config_test extends advanced_testcase {
    ...
    /**
     * Test that config is initialized with default and custom settings.
     *
     * @group tool_mergeusers
     * @group tool_mergeusers_config
     */
    ...
    /**
     * Test that config is initialized with default and hook settings.
     *
     * @group tool_mergeusers
     * @group tool_mergeusers_config
     */
    ...
    /**
     * Test that config is initialized with default hook and custom settings.
     *
     * @group tool_mergeusers
     * @group tool_mergeusers_config
     */
